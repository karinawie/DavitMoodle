...
$module->version   = 2014082000;               // If version == 0 then module will not be installed
...
$module->component = 'mod_davit'; // To check on upgrade, that module sits in correct place
