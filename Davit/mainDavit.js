...
function wait()
{
    ...
    while (new Date().getTime() < startTime + G_iMilliSeconds); // hog cpu
}

function setStepLag(pSeconds)
{
	G_iMilliSeconds=parseInt(pSeconds*1000);
}
